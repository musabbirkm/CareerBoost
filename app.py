...
if page == "Home":
    ...
    **About the Creator**: This app was built by Musabbir KM, a passionate developer dedicated to helping professionals succeed. Check out my portfolio at [OmniCipher](https://omnicipher.onrender.com) to learn more about my work!
    """)
